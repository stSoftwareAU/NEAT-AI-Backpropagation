...
- `scripts/test-check-family-sync-workflow.sh` (new, 17 cases) — runs the real
  ...
  `persist-credentials` left `true`, a tag-pinned action, a missing `ACTIONS_PUSH`
